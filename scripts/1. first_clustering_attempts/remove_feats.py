...
def encode_categorical_features(df):
    ...
    for column in df.columns:
        if column not in ['id', 'form', 'lemma', 'head']:
            ...
            with open(f"data/output/label_encoding.txt", "a") as f:
...
# original_df.to_csv("data/output/ro_rrt-ud-train.csv", index=False)
original_df.to_csv("data/output/test.csv", index=False)

# complete_df_encoded = encode_categorical_features(original_df)

# complete_df_encoded.to_csv("data/output/ro_rrt-ud-train_complete_categ.csv", index=False)
# complete_df_encoded.to_csv("data/output/test_complete_categ.csv", index=False)
...
new_df.to_csv("data/output/test_nummod-amod-det_categ.csv", index=False)